...
// End Cross Module References
...
#endif
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_PlayerSpeed;
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_AMainCharacter_Statics::NewProp_PlayerSpeed = { "PlayerSpeed", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AMainCharacter, PlayerSpeed), METADATA_PARAMS(Z_Construct_UClass_AMainCharacter_Statics::NewProp_PlayerSpeed_MetaData, ARRAY_COUNT(Z_Construct_UClass_AMainCharacter_Statics::NewProp_PlayerSpeed_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AMainCharacter, 429890306);
